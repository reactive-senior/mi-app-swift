...
open class DatePickerDialog: UIView {
    ...
    public init(textColor: UIColor = UIColor.black, buttonColor: UIColor = UIColor.darkGray, font: UIFont = .boldSystemFont(ofSize: 15), locale: Locale? = nil, showCancelButton:Bool = true) {
    ...
    open func show(_ title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", buttonColor: UIColor = UIColor.darkGray, defaultDate: Date , minimumDate: Date? = nil, maximumDate: Date? = nil, datePickerMode: UIDatePickerMode = .dateAndTime, callback: @escaping DatePickerCallback) {
        ...
        print("defaultDate" , dateFormatter.string(from:defaultDate))
        ...
        self.datePicker.locale = NSLocale.init(localeIdentifier: "fr") as Locale
